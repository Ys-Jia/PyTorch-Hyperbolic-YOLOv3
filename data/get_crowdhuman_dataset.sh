...
pip3 install --upgrade --user gdown > /dev/null
...
pwd
echo "** Unzip dataset files" # CrowdHuman_train02.zip CrowdHuman_train03.zip CrowdHuman_val.zip
for f in CrowdHuman_train01.zip; do
  unzip -n ${f}
done
